...
// ✅ ROHIT_45 BRANDING START
val nameId = "com.craftstudio.launcher"
val generatedRohit45Dir = file("$buildDir/generated/source/rohit45/java")
// ✅ ROHIT_45 BRANDING END
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "FIREBASE_API_KEY", "\"${project.findProperty("firebase_api_key") as? String ?: ""}\"")
        buildConfigField("String", "FIREBASE_APP_ID", "\"${project.findProperty("firebase_app_id") as? String ?: ""}\"")
        buildConfigField("String", "FIREBASE_PROJECT_ID", "\"${project.findProperty("firebase_project_id") as? String ?: ""}\"")
        buildConfigField("String", "FIREBASE_DATABASE_URL", "\"${project.findProperty("firebase_database_url") as? String ?: ""}\"")
        buildConfigField("String", "FIREBASE_LAUNCHER_PATH", "\"${project.findProperty("firebase_launcher_path") as? String ?: "launcher"}\"")
    }
    ...
    // ✅ Source folder map to CS branding
    sourceSets["main"].java.srcDirs(generatedRohit45Dir)
    ...
    packaging {
        jniLibs {
            ...
            pickFirsts += listOf("**/libbytehook.so", "**/libawt_xawt.so")
        }
    }
...
tasks.register("generateInfoDistributor") {
    doLast {
        ...
        generateJavaClass(generatedRohit45Dir, nameId, "InfoDistributor", constantMap)
    }
}
...
dependencies {
    ...
    // ✅ NanoHTTPD — YggdrasilServer ke liye required
